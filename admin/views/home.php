...
<div class="content-body">
    <div class="container-fluid pd-x-0">
        ...
        <div class="row">
            <?php if (countRow(["table"=>"tickets","where"=>["client_new"=>2]]) > 0 OR countRow(["table"=>"tickets","where"=>["status"=>"pending"]]) > 0): ?>
                <div class="col-md mg-b-30">
                    <div class="alert alert-warning">
                        There are unanswered support requests. Remember that the best customer satisfaction goes through fast support. And reply them all ASAP.
                    </div>
                </div>
            <?php endif ?>
            <?php if (countRow(["table"=>"payments","where"=>["payment_method"=>6,"payment_status"=>1]]) > 0): ?>
                <div class="col-md mg-b-30">
                    <div class="alert alert-warning">
                        There are new payment notifications, please check the accuracy and confirm the notification to add the balance to users.
                    </div>
                </div>
            <?php endif ?>
            <?php if (manualOrders() > 0): ?>
                <div class="col-md mg-b-30">
                    <div class="alert alert-warning">
                        There are manual orders pending action. You should start the process manually, as it is not connected to any API.
                    </div>
                </div>
            <?php endif ?>
        </div>
        <div class="row">
            ...
            <div class="col-sm-3 mg-t-10">
                <div class="card card-body">
                    ...
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        <h1 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"><?php echo manualOrders() ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-lg-12">
            ...
            <div class="col-sm-3 mg-t-10">
                <div class="card card-body">
                    ...
                    <div class="d-flex d-lg-block d-xl-flex align-items-end">
                        <h1 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1"><?php echo $settings["csymbol"] . (totalPayments()>0?totalPayments():0) ?></h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 mg-t-10">
