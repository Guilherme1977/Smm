...
$(document).ready(function () {
    ...
    $("#serviceList").on('click', function() {
        $("#serviceListContent").html('<center><div class="modal-body"><img src="theme/admin/ajax-loading.gif" border="0" alt="loading"></div></center>');
    ...
    $('#modalDiv').on('show.bs.modal', function (e) {
        $("#modalContent").html('<center><div class="modal-body"><img src="theme/admin/ajax-loading.gif" border="0" alt="loading"></div></center>');
    ...
    $('[id^="delete_rate_button-"]').on('click', function() {
