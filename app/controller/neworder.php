...
if ($_POST):
    ...
    $posts = intval(htmlspecialchars($_POST["posts"]));
    $delay = intval(htmlspecialchars($_POST["delay"]));
    $otoMin = intval(htmlspecialchars($_POST["min"]));
    $otoMax = intval(htmlspecialchars($_POST["max"]));
