...
if ($action == "services_list"):
    ...
    foreach ($services as $service) {
        ...
        if ($service["service_secret"] == 2 || $search->rowCount()):
            ...
            $serviceList.= ">" . $service["service_name"] . " - " . priceFormat(service_price($service["service_id"])) . $settings['csymbol'] ."</option>";
        endif;
    }
        ...
        $serviceDetails.= '>90 minutes</option>
                  ...
                  <div class="col-lg">
                      ...
                      <div class="input-group" id="datetimepicker">
                          <input class="form-control" style="width:100%" name="expiry" id="expiryDate" value="' . $_SESSION["data"]["expiry"] . '" type="date" autocomplete="off">
